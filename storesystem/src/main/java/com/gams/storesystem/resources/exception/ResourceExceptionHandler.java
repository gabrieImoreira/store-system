...
public class ResourceExceptionHandler {
	...
	@ExceptionHandler(DataIntegrityException.class) //tratador de exceptions dessa excecao
	...
	@ExceptionHandler(MethodArgumentNotValidException.class) //tratador de exceptions dessa excecao
